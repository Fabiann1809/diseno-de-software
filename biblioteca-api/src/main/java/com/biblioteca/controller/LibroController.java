...
public class LibroController {
    ...
    // consultarDisponibilidad() del diagrama
    @GetMapping("/{id}/disponibilidad")
    public ResponseEntity<Boolean> consultarDisponibilidad(@PathVariable String id) {
        return ResponseEntity.ok(libroService.consultarDisponibilidad(id));
    }
}